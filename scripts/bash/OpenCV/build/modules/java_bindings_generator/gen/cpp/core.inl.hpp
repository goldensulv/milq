...
#include "/home/ozen/python/milq/scripts/bash/OpenCV/modules/core/include/opencv2/core/base.hpp"
#include "/home/ozen/python/milq/scripts/bash/OpenCV/modules/core/include/opencv2/core.hpp"
#include "/home/ozen/python/milq/scripts/bash/OpenCV/modules/core/include/opencv2/core/utility.hpp"
#include "/home/ozen/python/milq/scripts/bash/OpenCV/modules/core/misc/java/src/cpp/core_manual.hpp"
  ...
  (JNIEnv* env, jclass )
{
    ...
    try {
        ...
        int _retval_ = cv::getVersionMajor(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass )
{
    ...
    try {
        ...
        int _retval_ = cv::getVersionMinor(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass )
{
    ...
    try {
        ...
        int _retval_ = cv::getVersionRevision(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
//
//  void completeSymm(Mat& m, bool lowerToUpper = false)
//
