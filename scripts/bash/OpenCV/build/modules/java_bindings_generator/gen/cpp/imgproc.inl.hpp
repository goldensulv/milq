...
#include "/home/ozen/python/milq/scripts/bash/OpenCV/modules/imgproc/include/opencv2/imgproc/types_c.h"
#include "/home/ozen/python/milq/scripts/bash/OpenCV/modules/imgproc/include/opencv2/imgproc.hpp"
  ...
  (JNIEnv* env, jclass , jint fontFace, jint pixelHeight, jint thickness)
{
    ...
    try {
        ...
        double _retval_ = cv::getFontScaleFromHeight( (int)fontFace, (int)pixelHeight, (int)thickness );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jint fontFace, jint pixelHeight)
{
    ...
    try {
        ...
        double _retval_ = cv::getFontScaleFromHeight( (int)fontFace, (int)pixelHeight );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
//
//  void HoughLinesPointSet(Mat _point, Mat& _lines, int lines_max, int threshold, double min_rho, double max_rho, double rho_step, double min_theta, double max_theta, double theta_step)
//
...
//
//  void warpPolar(Mat src, Mat& dst, Size dsize, Point2f center, double maxRadius, int flags)
//
