...
samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.o: ../samples/cpp/tutorial_code/video/bg_sub.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/ozen/python/milq/scripts/bash/OpenCV/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.o"
	cd /home/ozen/python/milq/scripts/bash/OpenCV/build/samples/cpp && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.o -c /home/ozen/python/milq/scripts/bash/OpenCV/samples/cpp/tutorial_code/video/bg_sub.cpp
...
samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.i: cmake_force
	...
	cd /home/ozen/python/milq/scripts/bash/OpenCV/build/samples/cpp && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/ozen/python/milq/scripts/bash/OpenCV/samples/cpp/tutorial_code/video/bg_sub.cpp > CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.i
...
samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.s: cmake_force
	...
	cd /home/ozen/python/milq/scripts/bash/OpenCV/build/samples/cpp && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/ozen/python/milq/scripts/bash/OpenCV/samples/cpp/tutorial_code/video/bg_sub.cpp -o CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.s
...
bin/example_tutorial_bg_sub: 3rdparty/ippicv/ippicv_lnx/lib/intel64/libippicv.a
bin/example_tutorial_bg_sub: lib/libopencv_shape.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_videostab.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_viz.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_stitching.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_ml.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_objdetect.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_calib3d.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_superres.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_dnn.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_video.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_photo.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_features2d.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_flann.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_highgui.so.3.4.2
bin/example_tutorial_bg_sub: /usr/lib/x86_64-linux-gnu/libGLU.so
bin/example_tutorial_bg_sub: /usr/lib/x86_64-linux-gnu/libGL.so
bin/example_tutorial_bg_sub: lib/libopencv_videoio.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_imgcodecs.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_imgproc.so.3.4.2
bin/example_tutorial_bg_sub: lib/libopencv_core.so.3.4.2
bin/example_tutorial_bg_sub: samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/ozen/python/milq/scripts/bash/OpenCV/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_tutorial_bg_sub"
	cd /home/ozen/python/milq/scripts/bash/OpenCV/build/samples/cpp && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_tutorial_bg_sub.dir/link.txt --verbose=$(VERBOSE)
